...
class _HomePageState extends State<HomePage> {
  Future<Autogenerated> apiCall() async {
    var response = await http.get(Uri.parse(
        'https://api.rawg.io/api/games?key=5ac29048d12d45d0949c77038115cb56&${pageNum}'));
    return Autogenerated.fromJson(jsonDecode(response.body));
  }

  String? pageNum = 'page=1';
  String? previousKeyHolder;
  ...
  FutureBuilder<Autogenerated> homePageFutureBuilder() {
    return FutureBuilder<Autogenerated>(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        ...
        Autogenerated dataX = snapshot.data;
        pageNum = dataX.next!.substring(startIndex, finalIndex);
            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (BuildContext context, index) {
                  ...
                  ratingList.add(data[index].rating);
                  releasedList.add(data[index].released);
                  ...
                  return Padding(
                    ...
                    child: ListTile(
                      ...
                      leading: InkWell(
                          ...
                          child: buildImage2(uniqueImages[index], index)),
                      title: Column(
                        children: [
                          Text(
                            '${growableList[index]}',
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text('Rating : ${ratingList[index]}'),
                              SizedBox(
                                width: 20,
                              ),
                              Text('Release : ${releasedList[index]}'),
                            ],
                          )
                        ],
                      ),
